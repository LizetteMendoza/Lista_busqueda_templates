...
void Menu::userInterface(List<Cancion>& myList){
   ...
   switch(opc){
       ...
       case 1:  myList.deletAll(); //La lista se inicializa en el contructor pero si se quisiera usar un metodo deletAll har�a la misma funcion
                cout<<endl<<"La lista est� inicializada";
                break;
